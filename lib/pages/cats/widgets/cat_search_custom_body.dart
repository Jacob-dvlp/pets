...
class CatSearchCustomBody extends StatelessWidget {
  const CatSearchCustomBody({Key? key}) : super(key: key);
        ...
        builder: (controller) {
          return SizedBox(
              ...
              child: ListView.builder(
                  shrinkWrap: true,
                  itemCount: controller.searchCat.length,
                  itemBuilder: (context, index) {
                    final RequestDadaJsonModelCat model =
                        controller.searchCat[index];
