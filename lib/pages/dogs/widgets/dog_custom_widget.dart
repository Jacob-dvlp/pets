...
import '../../about_animal/about_animal_page.dart';
import '../dogs_controller.dart';

class DogCustomWidget extends StatelessWidget {
  const DogCustomWidget({Key? key}) : super(key: key);
        ...
        return SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              final ResponseModelDog model = controller.modelList[index];
